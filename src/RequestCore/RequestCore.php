...
namespace AliSlsLog\RequestCore;

use AliSlsLog\RequestCore\ResponseCore;
...
class RequestCore
{
    ...
    public function process_response($curl_handle = null, $response = null)
    {
        ...
        if (is_resource($curl_handle) || $curl_handle instanceof \CurlHandle) {
            ...
            if ($curl_handle && $this->response) {
                switch ($this->response_class) {
                    case 'ResponseCore':
                        $ret = new ResponseCore($this->response_headers, $this->response_body, $this->response_code, $curl_handle);
                        break;
                    default:
                        $ret = new $this->response_class($this->response_headers, $this->response_body, $this->response_code, $curl_handle);
                        break;
                }
                return $ret;
            }
    ...
    public function send_request($parse = false)
    {
        ...
        if ($this->response === false) {
            //throw new RequestCore_Exception('cURL resource: ' . $curl_handle . '; cURL error: ' . curl_error($curl_handle) . ' (' . curl_errno($curl_handle) . ')');
